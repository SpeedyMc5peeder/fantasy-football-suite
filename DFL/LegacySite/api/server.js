...
const DEFAULT_STATE = {
  ...
  bets: [
    ...
    },
    {
      ...
      targetUser: 'ALL',
      title: 'Commish Prop: Will Dom orchestrate 3+ blockbuster trades before Week 4?',
      terms: 'Any manager can take UNDER. Dom takes OVER.',
      stakes: '$10 per manager',
      creatorPick: 'OVER (3+ Trades)',
      targetPick: 'UNDER (< 3 Trades)',
      status: 'OPEN',
      acceptedBy: null,
      winner: null,
